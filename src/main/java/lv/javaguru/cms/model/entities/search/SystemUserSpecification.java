...
@AllArgsConstructor
public class SystemUserSpecification implements Specification<SystemUserEntity> {

    private SearchCondition criteria;

    @Override
    public Predicate toPredicate(Root<SystemUserEntity> root,
                                 CriteriaQuery<?> query,
                                 CriteriaBuilder builder) {

        Field field = ReflectionUtils.findField(SystemUserEntity.class, criteria.getField());
