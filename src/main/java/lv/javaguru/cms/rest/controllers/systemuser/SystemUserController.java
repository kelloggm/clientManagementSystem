...
import lv.javaguru.cms.services.systemuser.RegisterSystemUserService;
...
public class SystemUserController {
    ...
    @Autowired private RegisterSystemUserService registerSystemUserService;
    ...
    public RegisterSystemUserResponse register(@Valid @RequestBody RegisterSystemUserRequest request,
                                               Principal principal) {
        request.setSystemUserLogin(principal.getName());
        SystemUserEntity systemUser = registerSystemUserService.register(request);
        return RegisterSystemUserResponse.builder().systemUserId(systemUser.getId()).build();
    }
